...
<body>
    ...
    <div>
        <table class="border txt" width="100%">
            <thead>
                <tr>
                    <th class="border text-center" style="width:6%">ลำดับ</th>
                    <th class="border text-center" style="width:20%">ชื่อ-สกุล</th>
                    <th class="border text-center" style="width:25%">ตำแหน่ง</th>
                    <th class="border text-center" style="width:10%">ผลงาน</th>
                    <th class="border text-center" style="width:10%">พฤติกรรม</th>
                    <th class="border text-center" style="width:10%">คะแนนที่ได้</th>
...
if ($result->num_rows > 0) {
    foreach ($scores as $index => $row) {
        ...
        <tr>
            ...
            <td class="border text-center">' . $row['performance'] . '</td>
            <td class="border text-center">' . $row['behavior'] . '</td>
            <td class="border text-center">' . $row['score'] . '</td>
