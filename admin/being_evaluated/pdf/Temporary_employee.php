...
$sql = "SELECT * FROM estimate_score WHERE ests_year=$year AND duty_code = '8' AND duty_code = '6'";
...
while ($row = mysqli_fetch_array($query)) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>คะแนนปี'.$year.'ของพนักงานชั่วคราว</title>
        <style>
            body {
    ...
    <body>
        <h2>แบบแจ้งผลการประเมินปฏิบัติงานพนักงานมหาวิทยาลัยชั่วคราว</h2>
        <div class="section">
        ...
        <div class="section">
            ...
            ประเมินประจำปีงบประมาณ ' . $estimate_score_year . ' ผลงานตั้งแต่ 1 มิถุนายน ' . $oldyear . ' - 30 พฤษภาคม ' . $estimate_score_year . '
        </div>
        <div>
