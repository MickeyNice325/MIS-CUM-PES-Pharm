...
$sql = "SELECT * FROM estimate_score WHERE ests_year=$year AND duty_code <= '5' AND duty_code >= '4' AND duty_code='10'";
...
while ($row = mysqli_fetch_array($query)) {
    ...
    <body>
        <h2>แบบแจ้งผลการประเมินปฏิบัติงานพนักงานมหาวิทยาลัย</h2>
        <div class="section">
