...
if (isset($_FILES['file'])) {
    ...
    $stmt_insert = $conn->prepare("INSERT INTO estimate_score (staff_code, duty_code, performance, behavior, score, results, status, ests_year, round) VALUES (?, ?, ?, ?, ?, ?, 'waitcomplete', ?, ?)");
